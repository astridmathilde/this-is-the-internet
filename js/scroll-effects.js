...
const surfaceWeb = document.getElementById("surface-web").getElementsByClassName("text")[0];
const surfaceWebImg = document.getElementById("surface-web").getElementsByTagName("figure")[0];
const deepWeb = document.getElementById("deep-web").getElementsByClassName("text")[0];
const deepWebImg = document.getElementById("deep-web").getElementsByTagName("figure")[0]
const darkWeb = document.getElementById("dark-web").getElementsByClassName("text")[0];
